...

                {
                    (loading) ? (
                        ...
                        <div className="bg-slate-500/90 animate-show rounded-md py-5 px-3 my-16 mx-auto duration-500 hover:-translate-y-1">
                            ...
                            <span className="font-medium text-sm text-slate-700" dir="ltr">طول جغرافیایی: { data.coord.lon }</span><br /><br />
                            <span className="font-medium text-sm text-slate-700" dir="ltr">عرض جغرافیایی: { data.coord.lat }</span>
                        </div>
                    ) : (
